...
orchestrator.registerScenario("test_1", async (s, t) => {
  ...
  console.log('gowood_key', gowood_key);
  console.log('gowood_key.instances', gowood_key.instances());
  ...
  const result = await gowood_key.call("gowood_key", "gowood_key", "get_value_from_key", {"address": addr.Ok})
